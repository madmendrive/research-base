...
def store_macro(file_path, author):
    ...
    # Copy file — unless an identical copy is already stored under any date prefix
...
def analyse_macro(file_path):
    ...
    prompt += "\nThe raw text of the note is provided between <document> tags in the system context, for additional detail.\n"
